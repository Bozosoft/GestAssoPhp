 ...
 {* message erreur *}
	 ...
	 {else}
		...
		*  Pr&eacute;f&eacute;rence Association     <br />* D&eacute;tail des d&eacute;signations des activit&eacute;s  <br />* D&eacute;tail des types de cotisations<br />
		...
		<span class='TextenoirGras'>Lisez attentivement les aides des différentes pages ou consulter le site Web  <a href="http://gestassophp.free.fr/" title="Connexion">gestassophp</a></span><br /><br />
