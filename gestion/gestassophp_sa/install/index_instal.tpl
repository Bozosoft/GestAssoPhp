 {* Installation de GestAssoPhp+Pg index_install.tpl copyright 2007-2014  (c) JC Etiemble HTML5*}
<!doctype html>
...
<div id="conteneur_page">
	...
	<footer class="footer_pied_page">
		&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://jc.etiemble.free.fr/" target="_blank" title="R&eacute;alisation" >Version : {$version}</a>
    </footer>
