...
{* Affichage de la Table des cotisations *}	
		...
		<table style="width:100%;"> 
			<tr>
				...
				<th class="LignegrisTC" style="width:11%;">{* Colonne 2 Date Enr avec tri *}
				...
				<th class="LignegrisTC" style="width:11%;">{* Colonne 4 Date fin avec tri *}
				...
				<th class="LignegrisTC" style="width:24%;">{* Colonne 5 Nom Prénom avec tri *}  
				...
				<th class="LignegrisTC" style="width:16%;">{* Colonne 6 Type avec tri *} 
				...
				<th class="LignegrisTC" style="width:10%;">{* Colonne 7 Montant avec tri *}
				...
				<th class="LignegrisTC" style="width:8%;">{* Colonne 8 Status avec tri *}
				...
				<th class="LignegrisTC" style="width:5%;">{language name=tpl_col_actions}{* Colonne 9 Actions sans tri *}
				</th>
...
{foreach from=$cotis_adht item=item_cotis_adht key=ordre}
			<tr class="Lignegris{$item_cotis_adht.coul}">
				...
				<td >{* Colonne 5 Nom Prénom avec tri *}
				...
				<td>{$item_cotis_adht.nom_type_cotisation}</td> {* Colonne 6 Type avec tri *} 
				<td>{$item_cotis_adht.montant_cotis}</td> {* Colonne 7 Montant avec tri *}
				<td class="centre-txt">{$item_cotis_adht.cotis_txt}&nbsp;<span class="TextenoirR">
				{$item_cotis_adht.datemodiffiche_cotis}</span></td> {* Colonne 8 Status avec tri *}
				<td class="centre-txt"> {* Colonne 8 Actions sans tri *}
