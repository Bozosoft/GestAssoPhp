...
<div id="contenu"> 
  ...
  <p class="Textenoir"> 
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;- <?php echo _LANG_FICHE_ADHT_UPLOAD_PHOTO;?> qui sera redimensionn&eacute;e automatiquement &agrave; 66 pixels de larg et/ou 94 pixels de haut (<span class="TextenoirGras">Attention</span> celle ci doit &ecirc;tre au format GIF ou JPEG de taille maxi 800x600)<br/> 
	    La zone "<?php echo _LANG_FICHE_ADHT_FICHE_ENR ;?>" est remplie automatiquement lors du premier enregistrement de la fiche.</p>
<br/><span class="TextenoirGras">Attention</span><br/>- la zone <?php echo _LANG_FICHE_ADHT_COMPL;?>	ne doit pas comporter de retour &agrave; la ligne (touche Entr&eacute;e) afin de permettre un export correct du fichier "<?php echo ADHERENT_BENE ;?>s" au format tableur.<br/>
		- La zone "<span class="TextenoirGras"><?php echo _LANG_FICHE_ADHT_FICHE_ENR ;?></span> est remplie automatiquement lors du premier enregistrement de la fiche. Elle ne peut &ecirc;tre modifi&eacute;e que <span class="TextenoirGras">si le niveau de priorit&eacute; (9) vous y autorise</span><br/></p>
  <?php	}else { ?>
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;- <?php echo _LANG_FICHE_ADHT_UPLOAD_PHOTO;?> qui sera redimensionn&eacute;e automatiquement &agrave; 66 pixels de larg et/ou 94 pixels de haut (<span class="TextenoirGras">Attention</span> celle ci doit &ecirc;tre au format GIF ou JPEG de taille maxi 800x600)<br/>
  <span class="TextenoirGras">Attention</span><br/>- la zone <?php echo _LANG_FICHE_ADHT_COMPL;?>	ne doit pas comporter de retour &agrave; la ligne (touche Entr&eacute;e) afin de permettre un export correct du fichier "<?php echo ADHERENT_BENE ;?>s" au format tableur.<br/>
  <br/> 
