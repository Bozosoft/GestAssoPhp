...
// Récupère Prénom Nom du possesseur de la fiche pour afficher Liste des fichiers adhérents
	...
	// lecture de la table des fichiers relative à l'adhérent sur la Fiche en cours
	...
	while ($dbresult && $row = $dbresult->FetchRow()) {
		...
		$fichier[$indice]['coul'] = abs($indice) % 2; // Pour afficher 1 ligne sur 2  classs= Lignegris0  ou Lignegris1
		$indice++;
	}
