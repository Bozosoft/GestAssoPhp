...
function smarty_function_mailto($params)
{
    ...
    if ($encode === 'javascript') {
        ...
        return '<script>document.write(unescape(\'' . $js_encode . '\'))</script>'; // Modification JCE //return '<script type="text/javascript">document.write(unescape(\'' . $js_encode . '\'))</script>';
    } elseif ($encode === 'javascript_charcode') {
        for ($x = 0, $_length = strlen($string); $x < $_length; $x++) {
            $ord[] = ord($string[ $x ]);
        }
        return '<script>document.write(String.fromCharCode(' . implode(',', $ord) . '))</script>'; // Modification JCE // return '<script type="text/javascript">document.write(String.fromCharCode(' . implode(',', $ord) . '))</script>';
    } elseif ($encode === 'hex') {
