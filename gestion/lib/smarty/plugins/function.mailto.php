...
function smarty_function_mailto($params)
{
    ...
    if ($encode === 'javascript') {
        ...
        return '<script>document.write(unescape(\'' . $js_encode . '\'))</script>'; // Modification V3.1.44 JCE 20/02/22 // EX return '<script type="text/javascript">document.write(unescape(\'' . $js_encode . '\'))</script>';
